...
func CronStart() {
	...
	c.AddFunc("CRON_TZ=Asia/Ho_Chi_Minh 00 20 * * *", runCreateCaddieWorkingSlotJob)      // Chạy lúc 01h00 hàng ngày
	...
	c.AddFunc("CRON_TZ=Asia/Ho_Chi_Minh 45 19 * * *", runBookingLogutJob)                 // Chạy lúc 23h30 tối hàng ngày để logout các booking chưa checkout
