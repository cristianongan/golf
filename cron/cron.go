...
func CronStart() {
	...
	c.AddFunc("CRON_TZ=Asia/Ho_Chi_Minh 30 14 * * *", runReportCaddieFeeToDay)            // Chạy lúc 23h00 hàng ngày
	...
	c.AddFunc("CRON_TZ=Asia/Ho_Chi_Minh 00 23 * * *", runBookingLogutJob)                 // Chạy lúc 23h tối hàng ngày để logout các booking chưa checkout
