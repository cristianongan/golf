...
func CronStart() {
	...
	c.AddFunc("CRON_TZ=Asia/Ho_Chi_Minh 45 18 * * *", runCreateCaddieWorkingSlotJob)      // Chạy lúc 18h45 hàng ngày
	c.AddFunc("CRON_TZ=Asia/Ho_Chi_Minh 30 18 * * *", runResetCaddieStatusJob)            // Chạy lúc 18h30 tối hàng ngày để reset caddie status
