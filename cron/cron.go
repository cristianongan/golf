...
func CronStart() {
	...
	c.AddFunc("CRON_TZ=Asia/Ho_Chi_Minh 15 19 * * *", runCreateCaddieWorkingSlotJob)      // Chạy lúc 18h45 hàng ngày
	c.AddFunc("CRON_TZ=Asia/Ho_Chi_Minh 00 19 * * *", runResetCaddieStatusJob)            // Chạy lúc 18h30 tối hàng ngày để reset caddie status
