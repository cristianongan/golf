...
const (
	...
	CONFIG_FIRST_MILE_STONE_CAN_NOT_GREATER_THAN_SECOND = "FIRST_MILE_STONE_CAN_NOT_GREATER_THAN_SECOND"
)

// agency transaction status
const (
	AGENCY_BOOKING_TRANSACTION_INIT         = "INIT"
	AGENCY_BOOKING_TRANSACTION_SENT_REQUEST = "SENT_REQUEST"
	AGENCY_BOOKING_TRANSACTION_SUCCESS      = "SUCCESS"
	AGENCY_BOOKING_TRANSACTION_CANCEL       = "CANCEL"
	AGENCY_BOOKING_TRANSACTION_COMPLETE     = "COMPLETE"
)

// angency payment status
const (
	AGENCY_PAYMENT_WAIT    = "WAIT"
	AGENCY_PAYMENT_PAID    = "PAID"
	AGENCY_PAYMENT_EXPIRED = "EXPIRED"
	AGENCY_PAYMENT_CANCEL  = "CANCEL"
)

// angency request booking status
const (
	AGENCY_REQUEST_BOOKING_BOOKED        = "BOOKED"
	AGENCY_REQUEST_BOOKING_LOCK_TEE      = "LOCK_TEE"
	AGENCY_REQUEST_BOOKING_OPEN_LOCK_TEE = "OPEN_LOCK_TEE"
)

// agency's customer payment type
const (
	CUSTOMER_PAYMENT_TYPE_TRANSFER = "TRANSFER"
	CUSTOMER_PAYMENT_TYPE_CASH     = "CASH"
)
